...
class ForegroundLinearLayout(context: Context, attributeSet: AttributeSet, defStyle: Int) : LinearLayout(
  ...
  init {
    var a: TypedArray = context.obtainStyledAttributes(attributeSet, R.styleable.ForegroundView,
        defStyle, 0)
